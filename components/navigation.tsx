...
import { BookOpen, ChevronLeft, Code2, ExternalLink, Settings, Users, HelpCircle } from 'lucide-react'
  ...
  return (
    ...
    >
      <div className="flex h-full flex-col">
                  ...
                  <div className={cn("flex items-center", isCollapsed && "justify-center")}>
                    <TooltipProvider>
                      <Tooltip>
                          ...
                          <Link href={item.href}>
                            <Button
                              ...
                              className={cn(
                                ...
                                !isActive && 'hover:bg-zinc-800/50 hover:text-zinc-100',
                                isCollapsed ? 'mx-auto' : ''
                              )}
                            >
                        ...
                        {isCollapsed && (
                          <TooltipContent side="right" className="bg-zinc-900/90 text-zinc-100">
                            {item.name}
                          </TooltipContent>
                        )}
                      </Tooltip>
                          ...
                          <Link key={subItem.href} href={subItem.href}>
                            <Button
                              ...
                              className={cn(
                                ...
                                pathname === subItem.href ? 'text-blue-400 bg-blue-500/5' : 'text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800/50'
                              )}
                            >
                              {subItem.name}
                            </Button>
        ...
        <div className={cn("p-4 border-t border-zinc-800", isCollapsed && "flex justify-center")}>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
