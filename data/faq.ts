...
export const faqs: FAQ[] = [
  {
    ...
    shortAnswer: "E-Z Host and E-Z Bio offer a range of features for standard users, including file hosting and customizable bio pages.",
    category: "Services",
    sections: [
      {
...
Play your favourite music on your bio`
...

  {
    ...
    shortAnswer: "Creating an account is fairly easy, all you need is an invite code, a discord account and a valid email address.",
...
`
      },
      {
        ...
        type: "text",
        content: "Once completed, you'll have full access to all E-Z services and features. Make sure to join our Discord server to stay updated with the latest news and updates."
      },
      {
...
- Keep your invite code private until registered`
  ...
  },
  {
    ...
    shortAnswer: "Open a ticket in our Discord server and request a password reset, ensuring you have access to the email linked to your account.",
    category: "Account Management",
    sections: [
      {
        title: "Reset Process",
